        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody id="events-table-body" class="divide-y border-t transition-opacity duration-300">
                    ...
                    <tr class="hover:bg-indigo-50/50 transition cursor-pointer group" onclick="window.location='{{ route('detail-event', $event->id) }}'">
                        ...
                        <td class="px-8 py-6">
                            <p class="font-black text-slate-800 mb-1 group-hover:text-indigo-600 transition">{{ $event->title }}</p>
