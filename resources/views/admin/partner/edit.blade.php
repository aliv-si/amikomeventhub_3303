                    ...
                    <label id="dropzone" for="logo" class="mt-1 @if($partner->logo) hidden @endif flex justify-center px-6 pt-5 pb-6 border-2 border-slate-200 border-dashed rounded-[1.5rem] hover:border-indigo-400 transition-colors cursor-pointer relative">
                        <div class="space-y-1 text-center">
                            ...
                            <div class="flex text-sm text-slate-600 justify-center">
                                <span class="font-bold text-indigo-600 hover:text-indigo-500">Pilih file logo baru</span>
                                <p class="pl-1">atau seret dan lepas</p>
                            </div>
                            <p class="text-xs text-slate-400">PNG, JPG, JPEG up to 2MB (Biarkan kosong jika tidak ingin mengubah logo)</p>
                        </div>
                    </label>
...
<script>
    const initialLogoUrl = "{{ $partner->logo ? asset('storage/' . $partner->logo) : '#' }}";
