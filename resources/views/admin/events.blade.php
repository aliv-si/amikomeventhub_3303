                ...
                <tbody id="events-table-body" class="divide-y border-t transition-opacity duration-300">
                    ...
                    <tr class="hover:bg-slate-50/50 transition">
                        ...
                        <td class="px-8 py-6">
                            ...
                            <p class="text-xs text-slate-400">Kuota: {{ $event->quota }}</p>
                        </td>
                        <td class="px-8 py-6">
                            <div class="flex gap-2">
                                ...
                                <form action="#" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus event ini?')" class="inline-block">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
