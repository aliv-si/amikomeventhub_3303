...
<body class="bg-indigo-900 text-white min-h-screen flex items-center justify-center p-6">
    <div class="max-w-md w-full bg-white text-slate-900 rounded-[2rem] p-8 shadow-2xl">
        ...
        <p class="text-center mt-6 text-slate-500 font-medium">Ingin gabung untuk jadi tenant? <a href="{{ route('admin.register') }}" class="text-indigo-600 font-bold hover:underline">Daftar</a></p>
    </div>
</body>