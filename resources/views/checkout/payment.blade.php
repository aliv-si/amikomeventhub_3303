...
@section('content')
<main class="w-full h-screen flex flex-col items-center justify-center px-6 text-center overflow-hidden">
    <div class="bg-white rounded-3xl border border-slate-200 p-12 shadow-sm w-full max-w-md">
